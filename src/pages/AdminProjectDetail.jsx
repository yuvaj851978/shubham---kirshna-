        ...
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <button 
              ...
              className="btn" 
              style={{ padding: '0.5rem 1rem', background: 'transparent', color: 'var(--primary-teal)', border: '1px solid var(--primary-teal)' }}
            >
              <ChevronLeft size={18} /> Back to Dashboard
            </button>
            <div style={{ background: 'var(--accent-gold)', color: 'white', padding: '0.5rem 1rem', borderRadius: '20px', fontSize: '0.85rem', fontWeight: 600 }}>
              Admin Preview Mode
            </div>
          </div>
          ...
          <div className="detail-grid">
            ...
            >
              ...
              <div className="detail-section">
                ...
                >
                  <button 
                    ...
                    style={{ position: 'absolute', top: '10px', right: '10px', zIndex: 1000, background: 'white', color: 'var(--accent-dark)', border: 'none', padding: '0.5rem 1rem', borderRadius: 'var(--radius-sm)', cursor: 'pointer', boxShadow: 'var(--shadow-md)', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.5rem' }}
                  >
              ...
              <a 
                ...
                style={{ position: 'absolute', top: '10px', left: '10px', zIndex: 1000, background: 'var(--accent-dark)', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: 'var(--radius-sm)', cursor: 'pointer', boxShadow: 'var(--shadow-md)', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }}
              >
